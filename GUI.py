...
class GUI:
    ...
    def StartAlgorithm(self):
        ...
        self.master.update()
                    ...
                    # if self.algMenu.get() == "Algoritmo de Inserción":
                    #     insertion_sort(self.data, self.drawData, self.speedScale.get())
                    # elif self.algMenu.get() == "Algoritmo por Mezcla":
                    #     merge_sort(self.data, self.drawData, self.speedScale.get())
